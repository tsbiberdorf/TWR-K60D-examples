...
**     Date/Time   : 2013-11-18, 10:26, # CodeGen: 2
**     Abstract    :
...
LDD_TDeviceData* IO1_Init(LDD_TUserData *UserDataPtr)
{
  ...
  DeviceDataPrv = (IO1_TDeviceData *)pvPortMalloc(sizeof(IO1_TDeviceData));
  ...
  UART_PDD_SetBaudRate(UART3_BASE_PTR, 27U); /* Set the baud rate register. */
